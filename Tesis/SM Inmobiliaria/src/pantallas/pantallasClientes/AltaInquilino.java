 ...
 * @author Nahuel
 */
public class AltaInquilino extends javax.swing.JFrame {

    /**
     * Creates new form AltaInmueble
     */
    public AltaInquilino() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos del Inquilino"));
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(comboDgi, 0, 147, Short.MAX_VALUE)))))
                        .addGap(35, 35, 35)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
   ...
   try {
       ...
       try{
        ...
        propietario.setId(Integer.parseInt(idPropietario.getText()));
        propietario.setNombre(nombre.getText());
        propietario.setApellido(apellido.getText());
        propietario.setApellidoMaterno(apellidoM.getText());
        propietario.setDni(Integer.parseInt(dni.getText()));
        propietario.setFechaNac(fechaNacimiento);
        propietario.setEstadoCivil(estadoCivil.getText());
        propietario.setProfesion(profesion.getText());
        ...
        if(telefono.getText().isEmpty() ){
            ...
            propietario.setTel(Integer.parseInt(telefono.getText()));
        }
    ...
    private void cuitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cuitKeyPressed

    }//GEN-LAST:event_cuitKeyPressed
...
char validar=evt.getKeyChar();
    ...
    private void estadoCivilKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_estadoCivilKeyTyped
...
char validar=evt.getKeyChar();
    ...
    }//GEN-LAST:event_estadoCivilKeyTyped
...
char validar=evt.getKeyChar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaInquilino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               new AltaInquilino().setVisible(true);
            }
        });
    }
