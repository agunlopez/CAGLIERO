...
public class AltaPropietario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos del Propietario"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            try{
                ...
                evento.setDescipcion("Se agregego el Propietario "+propietario.getNombre()+" "+propietario.getApellido()+" "+propietario.getApellidoMaterno());
                evento.setFecha(GestorEventos.getFechaActual());
                int r=gestP.altaPropietario(propietario);					
                if (r==1){
