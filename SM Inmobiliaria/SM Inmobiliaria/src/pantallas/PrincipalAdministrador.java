   ...
   actualizarSaldos();
    ...
    if(evt.getClickCount()==2){
	    ...
	    int id=Integer.parseInt(tablaContratos.getValueAt(row, 0).toString());
            ...
            inicioCon=(String) tablaContratos.getValueAt(row, 6);
...
AltaCliente altaPropietario=new AltaCliente();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        try{
            ...
            JasperReport listaInmuebles=JasperCompileManager.compileReport("C:\\Users\\Usuario\\Documents\\NetBeansProjects\\SMINMOBILIARIA\\SM Inmobiliaria\\SM Inmobiliaria\\src\\Recibos\\listaInmueblesDisponibles.jrxml");           
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ...
        int eleccion = JOptionPane.showOptionDialog(null, "¿En realidad desea cerrar sesion?", "Mensaje de Confirmacion",
